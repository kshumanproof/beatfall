...
(function () {
  ...
  BF.showDeviceReplaced = function () {
    ...
    el.innerHTML =
      ...
      +   '<div class="bf-brand bf-ended-brand"><span class="brandmark"></span>'
      +     '<span class="brandtag" role="img" '
      +     'aria-label="Where your story falls into place."></span></div>'
    ...
    css.textContent = [
      ...
      '.bf-brand{display:inline-block;line-height:0;text-decoration:none}',
      '.bf-brand .brandmark{display:block;height:calc(var(--wm) * .913);',
      '  aspect-ratio:1199 / 260;background:url("/brand/lockup.png") no-repeat left center/contain}',
      ':root[data-theme="dark"] .bf-brand .brandmark{background-image:url("/brand/lockup-dark.png")}',
      '@media (prefers-color-scheme: dark){:root:not([data-theme="light"]) .bf-brand .brandmark{',
      ...
      '.bf-ended-brand{--wm:42px;margin:0 0 27px;color:var(--ink-3,#726859)}',
  ...
  BF.showSmallScreenGate = function (session) {
    ...
    el.innerHTML =
      ...
      +   '<div class="bf-brand bf-gate-brand"><span class="brandmark"></span>'
      +     '<span class="brandtag" role="img" '
      +     'aria-label="Where your story falls into place."></span></div>'
    ...
    css.textContent = [
      ...
      '  -webkit-mask:var(--tagline-src, url("/brand/tagline.svg")) no-repeat left center/contain;',
      '  mask:var(--tagline-src, url("/brand/tagline.svg")) no-repeat left center/contain}',
      '.bf-gate-brand{--wm:42px;margin:0 0 30px;color:var(--ink-3,#726859)}',
